"undefined"==typeof vfplayer&&(
        vfplayer=function(h){
           if(vfplayer.api)
              return vfplayer.api.selectPlayer(h)
            },

vfplayer.version="6.10.4892",
vfplayer.vid=document.createElement("video"),vfplayer.audio=document.createElement("audio"),vfplayer.source=document.createElement("source"),function(h){function c(f){return function(){return a(f)}}function l(f,a,k,m,d){return function(){var b,c;if(d)k(f);else{try{if(b=f.responseXML)if(c=b.firstChild,b.lastChild&&"parsererror"===b.lastChild.nodeName){m&&m("Invalid XML",
...
a(RegExp("iP(hone|ad|od).+\\sOS\\s"+f,"i")):a(/iP(hone|ad|od)/i)};e.isAndroidNative=function(f){return e.isAndroid(f,!0)};e.isAndroid=function(f,b){return b&&a(/chrome\/[123456789]/i)&&!a(/chrome\/18/)?!1:f?(e.isInt(f)&&!/\./.test(f)&&(f=""+f+"."),a(RegExp("Android\\s*"+f,"i"))):a(/Android/i)};e.isMobile=function(){return e.isIOS()||e.isAndroid()};e.saveCookie=function(f,a){j.cookie="vfplayer."+f+"\x3d"+a+"; path\x3d/"};e.getCookies=function(){for(var f={},a=j.cookie.split("; "),k=0;k<a.length;k++){var m=
a[k].split("\x3d");0===m[0].indexOf("vfplayer.")&&(f[m[0].substring(9,m[0].length)]=m[1])}return f};e.isInt=function(f){return 0===f%1};e.typeOf=function(f){var a=typeof f;return"object"===a?!f?"null":f instanceof Array?"array":a:a};e.translateEventResponse=function(f,a){var k=e.extend({},a);if(f==h.events.vfplayer_FULLSCREEN&&!k.fullscreen)k.fullscreen="true"===k.message,delete k.message;else if("object"==typeof k.data){var m=k.data;delete k.data;k=e.extend(k,m)}else"object"==typeof k.metadata&&
...
1<b.length?(d=parseFloat(b[b.length-1]),d+=60*parseFloat(b[b.length-2]),3==b.length&&(d+=3600*parseFloat(b[b.length-3]))):d=parseFloat(a);return d};e.serialize=function(a){return null===a?null:"true"==a.toString().toLowerCase()?!0:"false"==a.toString().toLowerCase()?!1:isNaN(Number(a))||5<a.length||0===a.length?a:Number(a)};e.addClass=function(a,b){a.className=a.className+" "+b};e.removeClass=function(a,b){a.className=a.className.replace(RegExp(" *"+b,"g")," ")}}(vfplayer),
...
function(h){var c=h.foreach,l={mp4:"video/mp4",
...
hls:"hls"},function(b,c){g[b]||(g[b]={});g[b].flash=c});g.types=l;g.mimeType=function(b){var e;c(l,function(c,a){!e&&a==b&&(e=c)});return e};g.extType=function(b){return g.mimeType(j[b])}}(vfplayer.utils),
...
function(h){var c=h.loaderstatus={NEW:0,LOADING:1,ERROR:2,COMPLETE:3},l=document;h.scriptloader=function(j){function g(b){a=c.ERROR;n.sendEvent(e.ERROR,b)}function b(b){a=c.COMPLETE;n.sendEvent(e.COMPLETE,b)}var e=vfplayer.events,n=h.extend(this,new e.eventdispatcher),a=c.NEW;this.load=function(){if(a==
c.NEW){var d=h.scriptloader.loaders[j];if(d&&(a=d.getStatus(),2>a)){d.addEventListener(e.ERROR,g);d.addEventListener(e.COMPLETE,b);return}var f=l.createElement("script");f.addEventListener?(f.onload=b,f.onerror=g):f.readyState&&(f.onreadystatechange=function(a){("loaded"==f.readyState||"complete"==f.readyState)&&b(a)});l.getElementsByTagName("head")[0].appendChild(f);f.src=j;a=c.LOADING;h.scriptloader.loaders[j]=this}};this.getStatus=function(){return a}};h.scriptloader.loaders={}}(vfplayer.utils),
...
c.substring(c.lastIndexOf("/")+1,c.length).split("?")[0].split("#")[0];if(-1<c.lastIndexOf("."))return c.substr(c.lastIndexOf(".")+1,c.length).toLowerCase()};h.stringToColor=function(c){c=c.replace(/(#|0x)?([0-9A-F]{3,6})$/gi,"$2");3==c.length&&(c=c.charAt(0)+c.charAt(0)+c.charAt(1)+c.charAt(1)+c.charAt(2)+c.charAt(2));return parseInt(c,16)}}(vfplayer.utils),function(h){var c="touchmove",l="touchstart";h.touch=function(j){function g(d){d.type==l?(a=!0,f=e(k.DRAG_START,d)):d.type==c?a&&(q||(b(k.DRAG_START,
...
k.TAP&&f&&(d.deltaX=d.x-f.x,d.deltaY=d.y-f.y);return d}var n=j,a=!1,d={},f=null,q=!1,k=h.touchEvents;document.addEventListener(c,g);document.addEventListener("touchend",function(d){a&&q&&b(k.DRAG_END,d);a=q=!1;f=null});document.addEventListener("touchcancel",g);j.addEventListener(l,g);j.addEventListener("touchend",g);this.addEventListener=function(a,b){d[a]=b};this.removeEventListener=function(a){delete d[a]};return this}}(vfplayer.utils),function(h){h.touchEvents={DRAG:"vfplayerDrag",DRAG_START:"vfplayerDragStart",
DRAG_END:"vfplayerDragEnd",TAP:"vfplayerTap"}}(vfplayer.utils),function(h){h.key=function(c){var l,j,g;this.edition=function(){return g&&g.getTime()<(new Date).getTime()?"invalid":l};this.token=function(){return j};h.exists(c)||(c="");try{c=h.tea.decrypt(c,"36QXq4W@GSBV^teR");var b=c.split("/");(l=b[0])?/^(free|pro|premium|enterprise|free)$/i.test(l)?(j=b[1],b[2]&&0<parseInt(b[2])&&(g=new Date,g.setTime(String(b[2])))):l="invalid":l="free"}catch(e){l="invalid"}}}(vfplayer.utils),function(h){var c=
...
function(b){b=(b.charCodeAt(0)&31)<<6|b.charCodeAt(1)&63;return String.fromCharCode(b)})}}}(vfplayer.utils),function(h){h.events={COMPLETE:"COMPLETE",ERROR:"ERROR",API_READY:"vfplayerAPIReady",vfplayer_READY:"vfplayerReady",
vfplayer_FULLSCREEN:"vfplayerFullscreen",
vfplayer_LARGEPLAYER:"vfplayerLargePlayer",
vfplayer_RESIZE:"vfplayerResize",
vfplayer_ERROR:"vfplayerError",
vfplayer_SETUP_ERROR:"vfplayerSetupError",
vfplayer_MEDIA_BEFOREPLAY:"vfplayerMediaBeforePlay",vfplayer_MEDIA_BEFORECOMPLETE:"vfplayerMediaBeforeComplete",vfplayer_COMPONENT_SHOW:"vfplayerComponentShow",
vfplayer_COMPONENT_HIDE:"vfplayerComponentHide",vfplayer_MEDIA_BUFFER:"vfplayerMediaBuffer",vfplayer_MEDIA_BUFFER_FULL:"vfplayerMediaBufferFull",vfplayer_MEDIA_ERROR:"vfplayerMediaError",vfplayer_MEDIA_LOADED:"vfplayerMediaLoaded",vfplayer_MEDIA_COMPLETE:"vfplayerMediaComplete",vfplayer_MEDIA_SEEK:"vfplayerMediaSeek",vfplayer_MEDIA_TIME:"vfplayerMediaTime",vfplayer_MEDIA_VOLUME:"vfplayerMediaVolume",vfplayer_MEDIA_META:"vfplayerMediaMeta",vfplayer_MEDIA_MUTE:"vfplayerMediaMute",vfplayer_MEDIA_LEVELS:"vfplayerMediaLevels",
vfplayer_MEDIA_LEVEL_CHANGED:"vfplayerMediaLevelChanged",vfplayer_CAPTIONS_CHANGED:"vfplayerCaptionsChanged",vfplayer_CAPTIONS_LIST:"vfplayerCaptionsList",vfplayer_CAPTIONS_LOADED:"vfplayerCaptionsLoaded",vfplayer_PLAYER_STATE:"vfplayerPlayerState",state:{BUFFERING:"BUFFERING",IDLE:"IDLE",PAUSED:"PAUSED",PLAYING:"PLAYING"},vfplayer_PLAYLIST_LOADED:"vfplayerPlaylistLoaded",vfplayer_PLAYLIST_ITEM:"vfplayerPlaylistItem",vfplayer_PLAYLIST_COMPLETE:"vfplayerPlaylistComplete",vfplayer_DISPLAY_CLICK:"vfplayerViewClick",
vfplayer_VIEW_TAB_FOCUS:"vfplayerViewTabFocus",vfplayer_CONTROLS:"vfplayerViewControls",vfplayer_USER_ACTION:"vfplayerUserAction",vfplayer_INSTREAM_CLICK:"vfplayerInstreamClicked",vfplayer_INSTREAM_DESTROYED:"vfplayerInstreamDestroyed",vfplayer_AD_TIME:"vfplayerAdTime",vfplayer_AD_ERROR:"vfplayerAdError",vfplayer_AD_CLICK:"vfplayerAdClicked",vfplayer_AD_COMPLETE:"vfplayerAdComplete",vfplayer_AD_IMPRESSION:"vfplayerAdImpression",vfplayer_AD_COMPANIONS:"vfplayerAdCompanions",vfplayer_AD_SKIPPED:"vfplayerAdSkipped",
vfplayer_AD_PLAY:"vfplayerAdPlay",vfplayer_AD_PAUSE:"vfplayerAdPause",vfplayer_AD_META:"vfplayerAdMeta",vfplayer_CAST_AVAILABLE:"vfplayerCastAvailable",vfplayer_CAST_SESSION:"vfplayerCastSession",vfplayer_CAST_AD_CHANGED:"vfplayerCastAdChanged"}}(vfplayer),
...
function(h){var c=h.utils;h.events.eventdispatcher=function(l,j){function g(b,a,d){if(b)for(var f=0;f<b.length;f++){var e=b[f];if(e){null!==e.count&&0===--e.count&&delete b[f];try{e.listener(a)}catch(g){c.log('Error handling "'+d+'" event listener ['+
...
f)}return!1}};this.addGlobalListener=function(b,a){try{"string"==c.typeOf(b)&&(b=(new Function("return "+b))()),e.push({listener:b,count:a||null})}catch(d){c.log("error",d)}return!1};this.removeGlobalListener=function(b){if(b){try{for(var a=e.length;a--;)e[a].listener.toString()==b.toString()&&e.splice(a,1)}catch(d){c.log("error",d)}return!1}};this.sendEvent=function(n,a){c.exists(a)||(a={});c.extend(a,{id:l,version:h.version,type:n});j&&c.log(n,a);g(b[n],a,n);g(e,a,n)}}}(window.vfplayer),function(h){var c=
{},l={};h.plugins=function(){};h.plugins.loadPlugins=function(j,g){l[j]=new h.plugins.pluginloader(new h.plugins.model(c),g);return l[j]};h.plugins.registerPlugin=function(j,g,b,e){var n=h.utils.getPluginName(j);c[n]||(c[n]=new h.plugins.plugin(j));c[n].registerPlugin(j,g,b,e)}}(vfplayer),
...
typeof d)return h.pluginmodes.HYBRID;if("undefined"!=typeof a)return h.pluginmodes.FLASH;if("undefined"!=typeof d)return h.pluginmodes.JAVASCRIPT};this.getNewInstance=function(a,b,c){return new d(a,b,c)};this.getURL=function(){return j}}}(vfplayer.plugins),function(h){var c=h.utils,l=h.events,j=c.foreach;h.plugins.pluginloader=function(g,b){function e(){f&&m.sendEvent(l.ERROR,{message:q});d||(d=!0,a=c.loaderstatus.COMPLETE,m.sendEvent(l.COMPLETE))}function h(){k||e();if(!d&&!f){var a=0,b=g.getPlugins();
...
function(a){c.exists(a)&&(a=g.addPlugin(a),a.addEventListener(l.COMPLETE,h),a.addEventListener(l.ERROR,r))});var d=g.getPlugins();j(d,function(a,b){b.load()})}h()};this.destroy=function(){m&&(m.resetEventListeners(),m=null)};var r=this.pluginFailed=function(){f||(f=!0,q="File not found",e())};this.getStatus=function(){return a}}}(vfplayer),
...
function(h){h.parsers={localName:function(c){return c?c.localName?c.localName:c.baseName?c.baseName:"":""},textContent:function(c){return c?c.textContent?h.utils.trim(c.textContent):
c.text?h.utils.trim(c.text):"":""},getChildNode:function(c,h){return c.childNodes[h]},numChildren:function(c){return c.childNodes?c.childNodes.length:0}}}(vfplayer),
...
function(h){var c=h.parsers;(c.jwparser=function(){}).parseEntry=function(l,j){for(var g=[],b=[],e=h.utils.xmlAttribute,n=0;n<l.childNodes.length;n++){var a=l.childNodes[n];if("vfplayer"==a.prefix){var d=c.localName(a);"source"==d?(delete j.sources,g.push({file:e(a,"file"),"default":e(a,"default"),label:e(a,"label"),type:e(a,"type")})):
...
!0:!1,b[n].kind=!b[n].kind.length?"captions":b[n].kind,b[n].label.length||delete b[n].label,j.tracks.push(b[n]))}return j}}(vfplayer),
...
function(h){var c=vfplayer.utils,l=c.xmlAttribute,j=h.localName,g=h.textContent,b=h.numChildren,e=h.mediaparser=function(){};e.parseGroup=function(h,a){var d,f,q=[];for(f=0;f<b(h);f++)if(d=h.childNodes[f],"media"==d.prefix&&j(d))switch(j(d).toLowerCase()){case "content":l(d,"duration")&&(a.duration=c.seconds(l(d,"duration")));0<b(d)&&(a=e.parseGroup(d,a));l(d,"url")&&
...
ja:"Japanese",pt:"Portuguese",ru:"Russian",es:"Spanish"};d=r[d]?r[d]:d;m.label=d}q.push(k)}a.hasOwnProperty("tracks")||(a.tracks=[]);for(f=0;f<q.length;f++)a.tracks.push(q[f]);return a}}(vfplayer.parsers),function(h){function c(b){for(var a={},d=0;d<b.childNodes.length;d++){var c=b.childNodes[d],g=e(c);if(g)switch(g.toLowerCase()){case "enclosure":a.file=l.xmlAttribute(c,"url");break;case "title":a.title=j(c);break;case "guid":a.mediaid=j(c);break;case "pubdate":a.date=j(c);break;case "description":a.description=
j(c);break;case "link":a.link=j(c);break;case "category":a.tags=a.tags?a.tags+j(c):j(c)}}a=h.mediaparser.parseGroup(b,a);a=h.jwparser.parseEntry(b,a);return new vfplayer.playlist.item(a)}var l=vfplayer.utils,j=h.textContent,g=h.getChildNode,b=h.numChildren,e=h.localName;h.rssparser={};h.rssparser.parse=function(j){for(var a=[],d=0;d<b(j);d++){var f=g(j,d);if("channel"==e(f).toLowerCase())for(var h=0;h<b(f);h++){var k=g(f,h);"item"==e(k).toLowerCase()&&a.push(c(k))}}return a}}(vfplayer.parsers),function(h){h.playlist=
function(c){var l=[];if("array"==h.utils.typeOf(c))for(var j=0;j<c.length;j++)l.push(new h.playlist.item(c[j]));else l.push(new h.playlist.item(c));return l}}(vfplayer),
...
function(h){var c=h.item=function(l){var j=vfplayer.utils,g=j.extend({},c.defaults,l),b,e;g.tracks=l&&j.exists(l.tracks)?l.tracks:[];0===g.sources.length&&(g.sources=[new h.source(g)]);for(b=0;b<g.sources.length;b++)e=g.sources[b]["default"],g.sources[b]["default"]=e?"true"==e.toString():!1,g.sources[b]=new h.source(g.sources[b]);
if(g.captions&&!j.exists(l.tracks)){for(l=0;l<g.captions.length;l++)g.tracks.push(g.captions[l]);delete g.captions}for(b=0;b<g.tracks.length;b++)g.tracks[b]=new h.track(g.tracks[b]);return g};c.defaults={description:void 0,image:void 0,mediaid:void 0,title:void 0,sources:[],tracks:[]}}(vfplayer.playlist),function(h){var c=vfplayer,l=c.utils,j=c.events,g=c.parsers;h.loader=function(){function b(b){try{var c=b.responseXML.childNodes;b="";for(var e=0;e<c.length&&!(b=c[e],8!=b.nodeType);e++);"xml"==g.localName(b)&&
(b=b.nextSibling);if("rss"!=g.localName(b))n("Not a valid RSS feed");else{var k=new h(g.rssparser.parse(b));a.sendEvent(j.vfplayer_PLAYLIST_LOADED,{playlist:k})}}catch(m){n()}}function c(a){n(a.match(/invalid/i)?"Not a valid RSS feed":"")}function n(b){a.sendEvent(j.vfplayer_ERROR,{message:b?b:"Error loading file"})}var a=new j.eventdispatcher;l.extend(this,a);this.load=function(a){l.ajax(a,b,c)}}}(vfplayer.playlist),function(h){var c=vfplayer.utils,l={file:void 0,label:void 0,type:void 0,"default":void 0};
h.source=function(j){var g=c.extend({},l);c.foreach(l,function(b){c.exists(j[b])&&(g[b]=j[b],delete j[b])});g.type&&0<g.type.indexOf("/")&&(g.type=c.extensionmap.mimeType(g.type));"m3u8"==g.type&&(g.type="hls");"smil"==g.type&&(g.type="rtmp");return g}}(vfplayer.playlist),function(h){var c=vfplayer.utils,l={file:void 0,label:void 0,kind:"captions","default":!1};h.track=function(j){var g=c.extend({},l);j||(j={});c.foreach(l,function(b){c.exists(j[b])&&(g[b]=j[b],delete j[b])});return g}}(vfplayer.playlist),
...
""+f.podcount)+a);return a};d.skipAd=function(a){e("skipAd",{tag:a.tag})};d.clickAd=function(a){k=1*new Date;e("clickAd",{tag:a.tag})};d.timeSinceClick=function(){return 1*new Date-k}}}(window.vfplayer),function(h,c){function l(a,b){a[b]&&(a[b]=g.getAbsolutePath(a[b]))}var j=c.cast,g=c.utils,b=c.events,e=b.state,n={};j.NS="urn:x-cast:com.longtailvideo.vfplayer";j.availability=null;j.available=function(a){a=a||j.availability;var b=h.chrome,c="available";b.cast&&b.cast.ReceiverAvailability&&(c=b.cast.ReceiverAvailability.AVAILABLE);
return a===c};j.controller=function(a,d){var f,q;function k(a,b){var d={command:a};void 0!==b&&(d.args=b);w.sendMessage(j.NS,d,O,function(a){j.log("error message",a);"Invalid namespace"===a.description&&A()})}function m(a){a=!!j.available(a.availability);N.available!==a&&(N.available=a,t(b.vfplayer_CAST_AVAILABLE))}function r(a){j.log("existing session",a);w||(K=a.session,K.addMessageListener(j.NS,x))}function x(e,f){var g=JSON.parse(f);if(!g)throw"Message not proper JSON";if(g.reconcile){K.removeMessageListener(j.NS,
x);var m=g.diff,h=K;if(!m.id||!g.appid||!g.pageUrl)m.id=c().id,g.appid=J.appid,g.pageUrl=Q,K=w=null;m.id===a.id&&(g.appid===J.appid&&g.pageUrl===Q)&&(w||(a.jwInstreamState()&&a.jwInstreamDestroy(!0),v(h),d.sendEvent(b.vfplayer_PLAYER_STATE,{oldstate:m.oldstate,newstate:m.newstate})),H(g));K=null}}function u(a){N.active=!!a;a=N;var d;d=w&&w.receiver?w.receiver.friendlyName:"";a.deviceName=d;t(b.vfplayer_CAST_SESSION,{})}function t(a){var b=g.extend({},N);d.sendEvent(a,b)}function p(a){var b=h.chrome;
...
I,function(a){j.error("set muted error",a);I()})};
...
a.getLargePlayer=function(){
return!!L.LargePlayer};

a.jwIsBeforePlay=function(){return!1};var l=a.jwSetCurrentCaptions;a.jwSetCurrentCaptions=function(a){l(a);z.sendCommand("caption",a)};a.jwSkipAd=function(a){y&&(y.skipAd(a),a=y.getAdModel(),a.complete=!0,d.sendEvent(b.vfplayer_CAST_AD_CHANGED,a))};a.jwClickAd=function(f){if(y&&300<y.timeSinceClick()&&(y.clickAd(f),d.state!==e.PAUSED)){var g={tag:f.tag};f.sequence&&
(g.sequence=f.sequence);f.podcount&&(g.podcount=f.podcount);c(a.id).dispatchEvent(b.vfplayer_AD_CLICK,g);h.open(f.clickthrough)}};a.jwPlayAd=a.jwPauseAd=a.jwSetControls=a.jwForceState=a.jwReleaseState=a.jwSetFullscreen=a.jwDetachMedia=a.jwAttachMedia=O;var n=c(a.id).plugins;n.vast&&n.vast.jwPauseAd!==O&&(S={jwPlayAd:n.vast.jwPlayAd,jwPauseAd:n.vast.jwPauseAd},n.vast.jwPlayAd=n.vast.jwPauseAd=O);I();u(!0);m!==K&&z.setup(E(),d)}function C(a){j.log("Cast Session status",a);a?I():(z.sendEvent(b.vfplayer_PLAYER_STATE,
{oldstate:d.state,newstate:e.BUFFERING}),F())}function F(){w&&(B(),w=null);if(M){delete a.jwSkipAd;delete a.jwClickAd;a.initializeAPI();var m=c(a.id).plugins;m.vast&&g.extend(m.vast,S);d.volume=f;d.mute=q;d.setVideo(M);d.duration=0;z&&(z.destroy(),z=null);y&&(y.destroy(),y=null);d.state!==e.IDLE?g.isIPad()||g.isIPod()?(a.jwStop(!0),M.sendEvent(b.vfplayer_PLAYER_STATE,{oldstate:e.BUFFERING,newstate:e.IDLE})):(d.state=e.IDLE,a.jwPlay(!0),a.jwSeek(d.position)):M.sendEvent(b.vfplayer_PLAYER_STATE,{oldstate:e.BUFFERING,
newstate:e.IDLE});M=null}u(!1)}function B(){w.removeUpdateListener(C);w.removeMessageListener(j.NS,D)}function D(a,b){var d=JSON.parse(b);if(!d)throw"Message not proper JSON";H(d)}function H(c){if("state"===c.type){if(y&&(c.diff.newstate||c.diff.position))y.destroy(),y=null,d.setVideo(z),d.sendEvent(b.vfplayer_CAST_AD_CHANGED,{done:!0});z.updateModel(c.diff,c.type);c=c.diff;void 0!==c.item&&d.item!==c.item&&(d.item=c.item,d.sendEvent(b.vfplayer_PLAYLIST_ITEM,{index:d.item}))}else if("ad"===c.type){null===
y&&(y=new j.adprovider(j.NS,w),y.init(),d.setVideo(y));y.updateModel(c.diff,c.type);var e=y.getAdModel();c.diff.clickthrough&&(e.onClick=a.jwClickAd);c.diff.skipoffset&&(e.onSkipAd=a.jwSkipAd);d.sendEvent(b.vfplayer_CAST_AD_CHANGED,e);c.diff.complete&&y.resetAdModel()}else"connection"===c.type?!0===c.closed&&A():j.error("received unhandled message",c.type,c)}function E(){var a=g.extend({},d.config);a.cast=g.extend({pageUrl:Q},J);for(var b="base autostart controls fallback fullscreen width height mobilecontrols modes playlistlayout playlistposition playlistsize primary stretching sharing related ga skin logo listbar".split(" "),
...
return a}function I(){if(w&&w.receiver){var a=w.receiver.volume;if(a){var b=100*a.level|0;P(!!a.muted);R(b)}}}function R(a){var c=L.volume!==a;c&&(L.volume=a,z.sendEvent(b.vfplayer_MEDIA_VOLUME,{volume:a}));return c}function P(a){var c=L.mute!==a;c&&(L.mute=a,z.sendEvent(b.vfplayer_MEDIA_MUTE,{mute:a}));return c}function O(){}var w=null,N={available:!1,active:!1,deviceName:""},L={volume:null,mute:null},Q=g.getAbsolutePath(h.location.href),J,z=null,y=null,M=null;f=d.volume;q=d.mute;var K=null,S=null;
...
console.error.apply(console,a)}}(window,vfplayer),function(h,c){function l(){c&&c.cast&&c.cast.isAvailable&&!a.apiConfig?(a.apiConfig=new c.cast.ApiConfig(new c.cast.SessionRequest(m),e,n,c.cast.AutoJoinPolicy.ORIGIN_SCOPED),c.cast.initialize(a.apiConfig,b,g)):15>k++&&setTimeout(l,1E3)}function j(){q&&(q.resetEventListeners(),q=null)}function g(){a.apiConfig=null}function b(){}function e(b){a.loader.sendEvent("session",{session:b});b.sendMessage(a.NS,{whoami:1})}function n(b){a.availability=b;a.loader.sendEvent("availability",
{availability:b})}window.chrome=c;var a=h.cast,d=h.utils,f=h.events,q,k=0,m=null;a.loader=d.extend({initialize:function(b){m=b;null!==a.availability?a.loader.sendEvent("availability",{availability:a.availability}):c&&c.cast?l():q||(q=new d.scriptloader("https://www.gstatic.com/cv/js/sender/v1/cast_sender.js"),q.addEventListener(f.ERROR,j),q.addEventListener(f.COMPLETE,l),q.load())}},new f.eventdispatcher("cast.loader"))}(window.vfplayer,window.chrome||{}),function(h){function c(b){return function(){return b}}
function l(){}var j=h.cast,g=h.utils,b=h.events,e=b.state;j.provider=function(h){function a(a){q.oldstate=q.newstate;q.newstate=a;d.sendEvent(b.vfplayer_PLAYER_STATE,{oldstate:q.oldstate,newstate:q.newstate})}var d=g.extend(this,new b.eventdispatcher("cast.provider")),f=-1,q={newstate:e.IDLE,oldstate:e.IDLE,buffer:0,position:0,duration:-1,audioMode:!1};d.isCaster=!0;d.init=function(){};d.destroy=function(){clearTimeout(f);_castSession=null};d.updateModel=function(a,c){a.newstate&&(q.newstate=a.newstate,
q.oldstate=a.oldstate||q.oldstate,d.sendEvent(b.vfplayer_PLAYER_STATE,{oldstate:q.oldstate,newstate:q.newstate}));if("ad"!==c){if(void 0!==a.position||void 0!==a.duration)void 0!==a.position&&(q.position=a.position),void 0!==a.duration&&(q.duration=a.duration),d.sendEvent(b.vfplayer_MEDIA_TIME,{position:q.position,duration:q.duration});void 0!==a.buffer&&(q.buffer=a.buffer,d.sendEvent(b.vfplayer_MEDIA_BUFFER,{bufferPercent:q.buffer}))}};d.supportsFullscreen=function(){return!1};d.setup=function(b,
c){c.state&&(q.newstate=c.state);void 0!==c.buffer&&(q.buffer=c.buffer);void 0!==b.position&&(q.position=b.position);void 0!==b.duration&&(q.duration=b.duration);a(e.BUFFERING);h("setup",b)};d.playlistItem=function(b){a(e.BUFFERING);h("item",b)};d.load=function(b){a(e.BUFFERING);h("load",b)};d.stop=function(){clearTimeout(f);f=setTimeout(function(){a(e.IDLE);h("stop")},0)};d.play=function(){h("play")};d.pause=function(){a(e.PAUSED);h("pause")};d.seek=function(c){a(e.BUFFERING);d.sendEvent(b.vfplayer_MEDIA_SEEK,
...
r?(g=r,j=h("iframe","",j),j.src="http://www.youtube.com/embed/"+c.youTubeID(g),j.width=d,j.height=f,j.style.border="none"):b()}}}(vfplayer),
...
function(h){var c=h.utils,l=h.events,j={};(h.embed.flash=function(b,e,n,a,d){function f(a,b,c){var d=document.createElement("param");d.setAttribute("name",b);d.setAttribute("value",c);a.appendChild(d)}function q(a,b,c){return function(){try{c&&document.getElementById(d.id+"_wrapper").appendChild(b);var e=document.getElementById(d.id).getPluginConfig("display");
...
return!1}}).getVars=function(b){return j[b]};var g=h.embed.flashCanPlay=function(b,e){if(c.isYouTube(b)||c.isRtmp(b,e)||"hls"==e)return!0;var g=c.extensionmap[e?e:c.extension(b)];return!g?!1:!!g.flash}}(vfplayer),
...
function(h){function c(b,c,g){if(null!==navigator.userAgent.match(/BlackBerry/i))return!1;if("youtube"===c||l.isYouTube(b))return!0;var a=l.extension(b);c=c||j.extType(a);if("hls"===c)if(g){g=l.isAndroidNative;if(g(2)||g(3)||g("4.0"))return!1;if(l.isAndroid())return!0}else if(l.isAndroid())return!1;
...
l.typeOf(j.playlist))return!0;for(var a=j.playlist[0].sources,b=0;b<a.length;b++)if(c(a[b].file,a[b].type,j.androidhls))return!0}catch(d){}return!1}};h.embed.html5CanPlay=c}(vfplayer),
...
function(h){var c=h.embed,l=h.utils,j=/\.(js|swf)$/;h.embed=l.extend(function(g){function b(){t="Adobe SiteCatalyst Error: Could not find Media Module"}var e=l.repo(),n=l.extend({},h.defaults),a=l.extend({},n,g.config),d=g.config,f=a.plugins,q=a.analytics,k=e+"jwpsrv.js",m=e+"sharing.js",r=e+"related.js",x=e+"gapro.js",
n=h.key?h.key:n.key,u=(new h.utils.key(n)).edition(),t,f=f?f:{};"free"==u&&a.advertising&&(j.test(a.advertising.client)?f[a.advertising.client]=a.advertising:f[e+a.advertising.client+".js"]=a.advertising);delete d.advertising;d.key=n;a.analytics&&j.test(a.analytics.client)&&(k=a.analytics.client);delete d.analytics;q&&!("free"===u||"enterprise"===u)&&delete q.enabled;if("free"==u||!q||!1!==q.enabled)f[k]=q?q:{};delete f.sharing;delete f.related;switch(u){case "free":case "enterprise":if(d.sitecatalyst)try{window.s&&
window.s.hasOwnProperty("Media")?new h.embed.sitecatalyst(g):b()}catch(p){b()}case "premium":a.related&&(j.test(a.related.client)&&(r=a.related.client),f[r]=a.related),a.ga&&(j.test(a.ga.client)&&(x=a.ga.client),f[x]=a.ga);case "pro":a.sharing&&(j.test(a.sharing.client)&&(m=a.sharing.client),f[m]=a.sharing),a.skin&&(d.skin=a.skin.replace(/^(beelden|bekle|five|glow|modieus|roundster|stormtrooper|vapor)$/i,l.repo()+"skins/$1.xml"))}d.plugins=f;g.config=d;g=new c(g);t&&g.errorScreen(t);return g},h.embed)}(vfplayer),
...
function(h){var c=vfplayer.utils;h.sitecatalyst=function(h){function j(b){a.debug&&c.log(b)}function g(a){a=a.split("/");a=a[a.length-1];a=a.split("?");return a[0]}function b(){if(!m){m=!0;var a=n.getPosition();j("stop: "+f+" : "+a);s.Media.stop(f,a)}}function e(){r||(b(),r=!0,j("close: "+f),s.Media.close(f),x=!0,k=0)}var n=h,a=c.extend({},n.config.sitecatalyst),d={onPlay:function(){if(!x){var a=n.getPosition();m=!1;j("play: "+f+" : "+a);s.Media.play(f,a)}},onPause:b,onBuffer:b,onIdle:e,onPlaylistItem:function(b){try{x=
...
f+" : "+a);s.Media.play(f,a)}k=a},onComplete:e},f,q,k,m=!0,r=!0,x;c.foreach(d,function(a){n[a](d[a])})}}(vfplayer.embed),function(h,c){var l=[],j=h.utils,g=h.events,b=g.state,e=document,n="getBuffer getCaptionsList getControls getCurrentCaptions getCurrentQuality getDuration getFullscreen getHeight getLockState getMute getPlaylistIndex getSafeRegion getPosition getQualityLevels getState getVolume getWidth isBeforeComplete isBeforePlay releaseState".split(" "),a="playlistNext stop forceState playlistPrev seek setCurrentCaptions setControls setCurrentQuality setVolume".split(" "),
d={onBufferChange:g.vfplayer_MEDIA_BUFFER,onBufferFull:g.vfplayer_MEDIA_BUFFER_FULL,onError:g.vfplayer_ERROR,

onSetupError:g.vfplayer_SETUP_ERROR,
onFullscreen:g.vfplayer_FULLSCREEN,
onLargePlayer:g.vfplayer_LARGEPLAYER,
onMeta:g.vfplayer_MEDIA_META,
onMute:g.vfplayer_MEDIA_MUTE,onPlaylist:g.vfplayer_PLAYLIST_LOADED,onPlaylistItem:g.vfplayer_PLAYLIST_ITEM,onPlaylistComplete:g.vfplayer_PLAYLIST_COMPLETE,onReady:g.API_READY,onResize:g.vfplayer_RESIZE,onComplete:g.vfplayer_MEDIA_COMPLETE,onSeek:g.vfplayer_MEDIA_SEEK,onTime:g.vfplayer_MEDIA_TIME,
onVolume:g.vfplayer_MEDIA_VOLUME,onBeforePlay:g.vfplayer_MEDIA_BEFOREPLAY,onBeforeComplete:g.vfplayer_MEDIA_BEFORECOMPLETE,onDisplayClick:g.vfplayer_DISPLAY_CLICK,onControls:g.vfplayer_CONTROLS,onQualityLevels:g.vfplayer_MEDIA_LEVELS,onQualityChange:g.vfplayer_MEDIA_LEVEL_CHANGED,onCaptionsList:g.vfplayer_CAPTIONS_LIST,onCaptionsChange:g.vfplayer_CAPTIONS_CHANGED,onAdError:g.vfplayer_AD_ERROR,onAdClick:g.vfplayer_AD_CLICK,onAdImpression:g.vfplayer_AD_IMPRESSION,onAdTime:g.vfplayer_AD_TIME,onAdComplete:g.vfplayer_AD_COMPLETE,
onAdCompanions:g.vfplayer_AD_COMPANIONS,onAdSkipped:g.vfplayer_AD_SKIPPED,onAdPlay:g.vfplayer_AD_PLAY,onAdPause:g.vfplayer_AD_PAUSE,onAdMeta:g.vfplayer_AD_META,onCast:g.vfplayer_CAST_SESSION},f={onBuffer:b.BUFFERING,onPause:b.PAUSED,onPlay:b.PLAYING,onIdle:b.IDLE};h.api=function(l){function k(a,b){j.foreach(a,function(a,c){p[a]=function(a){return b(c,a)}})}function m(a,b){var c="jw"+b.charAt(0).toUpperCase()+b.slice(1);p[b]=function(){var b=t.apply(this,[c].concat(Array.prototype.slice.call(arguments,
0)));return a?p:b}}function r(a){F=[];D&&D.destroy&&D.destroy();h.api.destroyPlayer(a.id)}function x(a,b){try{a.jwAddEventListener(b,'function(dat) { vfplayer("'+p.id+'").dispatchEvent("'+b+'", dat); }')}catch(c){j.log("Could not add internal listener")}}function u(a,b){A[a]||(A[a]=[],v&&C&&x(v,a));A[a].push(b);return p}function t(){if(C){if(v){var a=Array.prototype.slice.call(arguments,0),b=a.shift();if("function"===typeof v[b]){switch(a.length){case 6:return v[b](a[0],a[1],a[2],a[3],a[4],a[5]);
...
function(a,b,c,d){try{E[d]=c,t("jwDockAddButton",a,b,"vfplayer('"+p.id+"').callback('"+d+"')",d)}catch(e){j.log("Could not add dock button"+e.message)}};p.removeButton=function(a){t("jwDockRemoveButton",a)};p.callback=function(a){if(E[a])E[a]()};p.getMeta=function(){return p.getItemMeta()};p.getPlaylist=function(){var a=t("jwGetPlaylist");"flash"==p.renderingMode&&j.deepReplaceKeyName(a,["__dot__","__spc__","__dsh__","__default__"],["."," ","-","default"]);return a};p.getPlaylistItem=function(a){j.exists(a)||
(a=p.getPlaylistIndex());return p.getPlaylist()[a]};p.getRenderingMode=function(){return p.renderingMode};p.setFullscreen=function(a){j.exists(a)?t("jwSetFullscreen",a):t("jwSetFullscreen",!t("jwGetFullscreen"));return p};

p.setMute=function(a){
j.exists(a)?t("jwSetMute",a):t("jwSetMute",!t("jwGetMute"));return p}; 

p.setLargePlayer=function(a){
j.exists(a)?t("jwSetLargePlayer",a):t("jwSetLargePlayer",!t("jwSetLargePlayer"));return p}; 

p.lock=function(){return p};p.unlock=function(){return p};p.load=function(a){t("jwInstreamDestroy");h(p.id).plugins.googima&&t("jwDestroyGoogima");t("jwLoad",a);return p};p.playlistItem=function(a){t("jwPlaylistItem",
...
b.BUFFERING?t("jwPause"):t("jwPlay");return p};p.pause=function(a){a===c?(a=p.getState(),a==b.PLAYING||a==b.BUFFERING?t("jwPause"):t("jwPlay")):t("jwPause",a);return p};p.createInstream=function(){return new h.api.instream(this,v)};p.setInstream=function(a){return B=a};p.loadInstream=function(a,b){B=p.setInstream(p.createInstream()).init(b);B.loadItem(a);return B};p.destroyPlayer=function(){t("vfplayerDestroy")};p.playAd=function(a){var b=h(p.id).plugins;b.vast?b.vast.jwPlayAd(a):t("jwPlayAd",a)};
p.pauseAd=function(){var a=h(p.id).plugins;a.vast?a.vast.jwPauseAd():t("jwPauseAd")};k(f,function(a,b){G[a]||(G[a]=[],u(g.vfplayer_PLAYER_STATE,function(b){var c=b.newstate;b=b.oldstate;if(c==a){var d=G[c];if(d)for(var e=0;e<d.length;e++){var f=d[e];"function"==typeof f&&f.call(this,{oldstate:b,newstate:c})}}}));G[a].push(b);return p});k(d,u);j.foreach(n,function(a,b){m(!1,b)});j.foreach(a,function(a,b){m(!0,b)});p.remove=function(){if(!C)throw"Cannot call remove() before player is ready";r(this)};
...
c[e];if("function"===typeof f)try{a===g.vfplayer_PLAYLIST_LOADED&&j.deepReplaceKeyName(d.playlist,["__dot__","__spc__","__dsh__","__default__"],["."," ","-","default"]),f.call(this,d)}catch(h){j.log("There was an error calling back an event handler")}}};p.dispatchInstreamEvent=function(a){B&&B.dispatchEvent(a,arguments)};p.callInternal=t;p.playerReady=function(a){C=!0;v||p.setPlayer(e.getElementById(a.id));p.container=e.getElementById(p.id);j.foreach(A,function(a){x(v,a)});u(g.vfplayer_PLAYLIST_ITEM,
function(){H={}});u(g.vfplayer_MEDIA_META,function(a){j.extend(H,a.metadata)});u(g.vfplayer_VIEW_TAB_FOCUS,function(a){var b=p.getContainer();!0===a.hasFocus?j.addClass(b,"jw-tab-focus"):j.removeClass(b,"jw-tab-focus")});for(p.dispatchEvent(g.API_READY);0<F.length;)t.apply(this,F.shift())};p.getItemMeta=function(){return H};return p};h.playerReady=function(a){var b=h.api.playerById(a.id);b?b.playerReady(a):h.api.selectPlayer(a.id).playerReady(a)};h.api.selectPlayer=function(a){var b;j.exists(a)||
...
("flash"==d.renderingMode?"_wrapper":""))){"html5"===d.renderingMode&&d.destroyPlayer();var g=e.createElement("div");g.id=d.id;f.parentNode.replaceChild(g,f)}l.splice(b,1);return null}}(window.vfplayer),function(h){var c=h.events,l=h.utils,j=c.state;h.api.instream=function(g,b){function e(a,c){f[a]||(f[a]=[],b.jwInstreamAddEventListener(a,'function(dat) { vfplayer("'+g.id+'").dispatchInstreamEvent("'+a+'", dat); }'));f[a].push(c);return this}function h(a,b){q[a]||(q[a]=[],e(c.vfplayer_PLAYER_STATE,
...
function(a,b){var c=f[a];if(c)for(var d=c.length;d--;)c[d]===b&&c.splice(d,1)};k.dispatchEvent=function(a,b){var c=f[a];if(c)for(var c=c.slice(0),d=l.translateEventResponse(a,b[1]),e=0;e<c.length;e++){var g=c[e];"function"==typeof g&&g.call(this,d)}};k.onError=function(a){return e(c.vfplayer_ERROR,a)};k.onMediaError=function(a){return e(c.vfplayer_MEDIA_ERROR,a)};

k.onFullscreen=function(a){
return e(c.vfplayer_FULLSCREEN,a)
};

k.onLargePlayer=function(a){
return e(c.vfplayer_LARGEPLAYER,a)
};

k.onMeta=function(a){return e(c.vfplayer_MEDIA_META,a)};k.onMute=function(a){return e(c.vfplayer_MEDIA_MUTE,
a)};k.onComplete=function(a){return e(c.vfplayer_MEDIA_COMPLETE,a)};k.onPlaylistComplete=function(a){return e(c.vfplayer_PLAYLIST_COMPLETE,a)};k.onPlaylistItem=function(a){return e(c.vfplayer_PLAYLIST_ITEM,a)};k.onTime=function(a){return e(c.vfplayer_MEDIA_TIME,a)};k.onBuffer=function(a){return h(j.BUFFERING,a)};k.onPause=function(a){return h(j.PAUSED,a)};k.onPlay=function(a){return h(j.PLAYING,a)};k.onIdle=function(a){return h(j.IDLE,a)};k.onClick=function(a){return e(c.vfplayer_INSTREAM_CLICK,a)};
k.onInstreamDestroyed=function(a){return e(c.vfplayer_INSTREAM_DESTROYED,a)};k.onAdSkipped=function(a){return e(c.vfplayer_AD_SKIPPED,a)};k.play=function(a){b.jwInstreamPlay(a)};k.pause=function(a){b.jwInstreamPause(a)};k.hide=function(){g.callInternal("jwInstreamHide")};k.destroy=function(){k.removeEvents();g.callInternal("jwInstreamDestroy")};k.setText=function(a){b.jwInstreamSetText(a?a:"")};k.getState=function(){return b.jwInstreamState()};k.setClick=function(a){b.jwInstreamClick&&b.jwInstreamClick(a)}}}(window.vfplayer),
function(h){
...
c.selectPlayer=function(c){return(c=l(c))?c:{registerPlugin:function(c,b,e){h.plugins.registerPlugin(c,b,e)}}}}
